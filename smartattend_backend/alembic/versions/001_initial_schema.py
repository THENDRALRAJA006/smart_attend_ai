...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("is_face_registered", sa.Boolean(), server_default=sa.text("0")),
    ...
    op.create_table(
        ...
        sa.Column("embedding_json", mysql.LONGTEXT(), nullable=False),
        sa.Column("created_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP")),
    ...
    op.create_table(
        ...
        sa.Column("liveness_verified", sa.Boolean(), server_default=sa.text("0")),
